...
data class DriverPostModel(@SerializedName("id") val id: Long,
                           ...
                           @SerializedName("passengerOfferCount") val passengerOfferCount: Int? = null,
                           ...
                           @SerializedName("parcelOfferCount") val parcelOfferCount: Int? = null,
                           @SerializedName("passengerList") val passengerList: List<PassengerModel>? = null,
                           @SerializedName("parcelList") val parcelList: List<ParcelDTO>? = null,
