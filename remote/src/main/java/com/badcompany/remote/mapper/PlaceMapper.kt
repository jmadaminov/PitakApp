...
open class PlaceMapper @Inject constructor() : Mapper<PlaceEntity, PlaceModel> {
    ...
    override fun mapFromEntity(type: PlaceEntity): PlaceModel {
        return PlaceModel(type.districtId, type.regionId, type.nameRu, type.nameUz, type.nameEn, type.lat, type.lon, type.regionName)
    }
    ...
    override fun mapToEntity(type: PlaceModel): PlaceEntity {
        return PlaceEntity(type.districtId, type.regionId, type.nameRu, type.nameUz, type.nameEn, type.lat, type.lon, type.regionName)
    }
