package com.badcompany.pitak.ui.addpost.carandseat
...
import kotlinx.android.synthetic.main.fragment_car_and_seats.*
...
class CarAndSeatsFragment @Inject constructor(private val viewModelFactory: ViewModelProvider.Factory) :
    Fragment(R.layout.fragment_car_and_seats) {
...
//        }
    ...
    private fun setupListeners() {
        ...
        next.setOnClickListener {
            navController.navigate(R.id.action_carAndSeatFragment_to_previewFragment)
        }
